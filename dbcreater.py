...
c.execute("CREATE TABLE {0} ({1} PRIMARY KEY INTEGER, {2} TEXT, {3} TEXT);".format("accounts", "account_id", "username", "password"))
c.execute("CREATE TABLE {0} ({1} PRIMARY KEY INTEGER, {2} TEXT);".format("stories_viewable", "account_id", "titles"))
c.execute("CREATE TABLE {0} ({1} TEXT UNIQUE)") #notdone
